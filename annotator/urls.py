...
from annotator.views import Root, Index, Annot, Search, EditorView, EditorView2, mark
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<path>/document/(?P<doc_id>[\w\-]+)/edittest&page=(?P<page>[\w\-]+))$', EditorView2.as_view(), name='annotation.editor2'),
    url(r'^(?P<path>/document/(?P<doc_id>[\w\-]+)/edittest)$', EditorView2.as_view(), name='annotation.editor2'),
